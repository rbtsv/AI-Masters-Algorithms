...
@solutions = [ 
  ...
  #{:label => "DP-W-opt-wdecr", :file => "./K-sol-dpW-opt-w-decr" },    
  {:label => "DP-W-opt-inc", :file => "./K-sol-dpW-opt-w-inc" },    
  {:label => "DP-W-opt-mem", :file => "./K-sol-dpW-opt-mem" },    
  {:label => "DP-W-opt-mem-h", :file => "./K-sol-dpW-opt-mem-hash" },    
  {:label => "DP-W-opt-mem-m", :file => "./K-sol-dpW-opt-mem-map" },    
